    ...
    "TKT-001": {
        ...
        "status_events": [
            ...
            },
            {
                ...
                "summary": "Got it—restart didn't work, which tells us something good: it's not a simple reboot issue. 🔍 That means we need to dig deeper. Check your add-ins (they cause 60% of Excel crashes). Go to File → Options → Add-ins. Disable all non-Microsoft add-ins, then restart Excel.",
                "user_feedback": "Disabled them all like you said. Excel opened and it's working!",
            },
            {
                "time": "11:30",
                "phase": "Resolved",
                "event": "Resolved",
                "resolution": "All set! ✅ The issue was a faulty add-in. You can re-enable them one by one to find the culprit, or just leave them disabled if you don't need them. Let us know if you need help with that.",
                "user_feedback": "That worked and no further help needed! Excel is open now. Didn't know about add-ins.",
